...
This way, you can _forward_ your local SSH keys to the cluster, and GitHub (or any other service)
...
Here's an example. The best part about `sq` is that it shows the submit time, time elapsed, and time
